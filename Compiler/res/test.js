...
robot_2.animate(1000).dx(0.0).once(1, function(){robot_2.rotate(-67.38013505195958);}, true);
robot_1.animate(2000).dx(127.27922061357856).once(1, function(){robot_1.rotate(-22.380135051959574);}, true);
robot_2.animate(2000).dx(260.0).once(1, function(){robot_2.rotate(-325.00797980144137);}, true);
